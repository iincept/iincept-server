        ...
        {hoveredProduct ? (
          <div className="w-full h-[340px] rounded-2xl bg-[#f5f5f7] border border-zinc-200/80 p-0 shadow-sm overflow-hidden flex items-center justify-center transition-all duration-300 animate-in fade-in">
            <img
              ...
              className={isSeries12 ? "max-w-[92%] max-h-[92%] object-contain transition-transform duration-500 hover:scale-105 select-none p-1" : "w-full h-full object-cover p-0 transition-transform duration-500 hover:scale-105"}
